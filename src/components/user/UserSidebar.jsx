...
function UserSidebar({ setActiveContent }) {
        ...
        <nav className="sidebar-nav">
          <ul>
            ...
            <li>
              ...
              <Link to="GenerateTicket" className="nav-item">
            <li>
                <span>Generate Ticket</span>
                <MdToken className="nav-icon me-2" />
            </li>
              </Link>
              <Link  to="UserRaisedTicket" state={{tickets}} className="nav-item">
            <li>
                <span>Raised Tickets</span>
                <MdToken className="nav-icon me-2" />
            </li>
              </Link>
              <Link  to="UserAssignedTicket" state={{tickets}}className="nav-item">
            <li>
                <span>Assigned Tickets</span>
                <MdToken className="nav-icon me-2" />
            </li>
              </Link>
              <Link to="UserApprovedTicket" 
              state={{tickets}}
              className="nav-item">
                <li>

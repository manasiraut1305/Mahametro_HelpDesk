  ...
  return (
    <>
      ...
      >
        ...
        <div
  style={{
    backgroundColor: "rgb(242, 140, 40)", // Orange
    color: "white",
    display: "flex",
...
>
  <img
    // src={yourIconImage} // e.g. chatbot icon
    alt="Help Icon"
    style={{ height: "40px" }}
  />
  <h5 className="mb-0">Hello! How can I help you today?</h5>
</div>
...
>
  {["Raised", "Assigned", "Approved", "Resolved"].map((title, idx) => (
    <div
      key={idx}

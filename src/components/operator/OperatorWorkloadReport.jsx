...
import { totalWorkloadCountFunction } from "../../api/OperatorWorkloadCount";
import { TicketWorkloadReport } from "../../api/OperatorWorkloadReport";
...
function WorkloadReport({ projectName }) {
  ...
  useEffect(() => {
    const fetchTicketCounts = async () => {
      ...
      try {
        ...
        console.log("Payload for totalWorkloadCountFunction:", payload);
        const data = await totalWorkloadCountFunction(payload);
  ...
  useEffect(() => {
    const fetchDetailedReport = async () => {
      ...
      try {
        ...
        const response = await TicketWorkloadReport(payload);

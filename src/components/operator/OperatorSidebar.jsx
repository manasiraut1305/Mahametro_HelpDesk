...
import { Link, useNavigate } from "react-router-dom"; // Use NavLink for active styling
import ProjectCard from "./ProjectCard";
import { MdDashboard, MdTableChart, MdPassword, MdToken } from "react-icons/md";
      ...
      <aside className="sidebar">
        <nav className="sidebar-nav ">
          <ul>
            ...
            <Link to="/OperatorDashboardLayout" className="nav-item">
              <li>
                <span>Dashboard</span>
            ...
            <Link to="OperatorAddTicket" className="nav-item">
              <li>
            ...
            <Link to="OperatorAssignedTicket" className="nav-item">
              <li>
            ...
            <Link to="OperatorApprovedTicket" className="nav-item">
              <li>
            ...
            <Link to="OperatorResolvedTicket" className="nav-item">
              <li>
                <span>Resolved Tickets</span>
                <MdToken className="nav-icon me-2" />
              </li>
            </Link>
            <Link to="OperatorRejectedTicket" className="nav-item">
              <li>
